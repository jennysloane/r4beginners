...
```{r}
artists <- c("jennifer", "taylor", "miley")
artists
```
...
```{r}
artists_heights = c(64.57, 70.87, 64.96)
```

What is the class of `artists_heights`?

```{r}
class(artists_heights)
```
...
Hint: if you get stuck, try to use the internet to learn how to print letters of the alphabet in R.
